  ...
  return (
    <div className="mt-6">
      <div className="relative mb-4 flex items-center">
        ...
        <span className="px-3 text-xs font-medium uppercase tracking-wide text-ink-3">
          or
        </span>
        <span className="h-px flex-1 bg-rule" aria-hidden="true" />
      </div>
        ...
        {providers.map((provider) => {
          ...
          return (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-none border border-rule-strong bg-white px-4 py-2.5 text-sm font-medium text-ink-2 transition hover:bg-inset focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-go focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
            >
